...
const DocteurForm:FunctionComponent<BtnProps> = ({open,data,loading,setOpen,handleValidate}) => {
                ...
                <div className="flex min-h-full items-center justify-center px-4 py-8">
                    ...
                    >
                        <Dialog.Panel style={{borderWidth:2,borderColor:"#ff8041"}} className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                            ...
                            <div style={{color:"#ff8041"}} className="uppercase underline">{params.id ? 'Editer Docteur' : 'Ajouter Docteur'}</div>
                            </div>
                            <div className="p-5">
                              <form>
                                 <div className="mb-5">
                                ...
                                <div className="mb-5">
                                    ...
                                    <input id="prenom" type="text" placeholder="Entrer le prenom" className="form-input" value={params.prenom} onChange={(e) => changeValue(e)} />
                                </div>
